...
class BlogseoController extends Controller
{
     ...
     if($request->isMethod('POST'))
      {
    	...
    	return view('Blogseo.add_blogseo',compact('blog'));
    }
    ...
    {
    	$viewseo= blogseo::get();
        return view('Blogseo.view_blogseo')->with(compact('viewseo'));
    }
    ...
    public function edit_blogseo(Request $request,$id)
    {
        if($request->isMethod('post'))
      {
       ...
       return view('Blogseo.edit_blogseo')->with(compact('blogseo','blog'));
    }
